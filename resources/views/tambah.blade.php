...
<div class="row justify-content-center">
  ...
  <div class="col-lg-5 ">
    ...
    <h1 class="h3 mb-3 fw-normal text-center">Add Book</h1>
    <main class="form-regis">
      <form method="POST" action="/dasss">
        @csrf
        <div class="form-floating">
            <input type="text" name="judul" class="form-control rounded-top" required id="judul">
